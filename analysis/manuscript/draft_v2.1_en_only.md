...
Moni1000 data were provided by the Biodiversity Center of Japan, Ministry of Environment (approval no. Approval No. 2601271). Satellite SST data are publicly available from NOAA Coral Reef Watch.
...
*Word count: ~3,200 (excluding tables, figures, and references)*
