...
| ファイル | 内容 | 更新方法 |
|----------|------|----------|
| `data/dhw_annual_peak.json` | DHW年次ピーク（2003-2024、3地点） | 手動でSQL実行→JSON生成→git push |
...
# DHW年次ピーク取得例
result = client.rpc('get_dhw_annual_peak', {'p_site': 'sesoko', 'p_year': 2024}).execute()
```
